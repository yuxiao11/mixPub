...
public class ExcellentVideoRecallTest {
    public static void main(String[] args) throws Exception {
        ...
        //画像权重过滤
        List<RecordInfo> filteredRecordInfoList = profileTagWeightFilter(userModel.getVideo_cate(), 0.5d);

        MixRequestInfo mixRequestInfo = new MixRequestInfo();
        mixRequestInfo.setUid(uid);
        ExcellentVideoRecall coTagRecallExecutor = new ExcellentVideoRecall(mixRequestInfo, filteredRecordInfoList, UserProfileEnum.TagPeriod.LONG, 180);

...
@Getter
@Setter
public class LogicParams4videoUser extends LogicParams {
     ...
     * 试探的视频的召回量
     */
    public int expVideoNum = 150;
    public int expVideoScNum = 250;

    public int expVideoUcbNum = 350;
    public int expVideoScUcbNum = 350;
     ...
     * topic 视频召回数量控制
     */
    public int topicVideoLongNum = 1100;
    public int topicVideoLastNum = 70;

    /**
     * 姜明明计算的使用图文标签打给视频 召回数量控制
     */
    public int cotagVideoByDocLongNum = 250;

    /**
     * cotag video 召回数量控制
     */
    public int cotagCrawVideoLongNum = 600;
    public int cotagVideoLongNum = 300;
    public int cotagVideoRecentNum = 150;
    public int cotagVideoLastNum = 50;
    public int cotagVideoTotalNum = 600;

    public int cotagVideoForNewTagLongNum = 200; 
    public int cotagVideoForNewTagRecentNum = 200; 
     ...
     */
    public int cotagVideoSimLastNum = 250;
    public int cotagVideoSimRecentNum = 300;
     ...
     */
    public int cotagSmallVideoLongNum = 70;
    public int cotagSmallVideoRecentNum = 70;
    public int t1SmallVideoRecentNum = 70;

    public int CSmallVideoRecentNum = 80;
    /**
     * toutiaoFirst 召回数量控制
     */
    ...
    public int videoExcellentScNum = 150;

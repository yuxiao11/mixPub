...
public class TrieTree {
    ...
    //距离子节点
    private Set<TrieTree> rexDistanceNode = new HashSet<>();
    ...
    private int rexDistance = 0;
    //当前节点所有距离节点的最大值。
    private int maxRexDistance = 0;
     ...
     */
    private Map<String, List<Integer>> detect(String str) {
        int i = 0;
    ...
    public boolean matches(String str) {
        ...
        if (result.size() == 0) {
            ...
            logger.info("filter, title:{} ,keywords:{}", str, result.keySet());
            return true;
        }
    }
     ...
     * @return
     */
    public int matchesPoints(String str, int limit) {
        str = str.toLowerCase();
        ...
        if (points > limit) {
            logger.info("title:{} points filtered ,keywords:{}, score:{}", str, result.keySet(), limit);
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        int points = tree.matchesPoints("数量的分开就<小王>,王思聪", 3);
